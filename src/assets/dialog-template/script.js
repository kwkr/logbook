var countries = window.autocompleteOptions;
if (!countries) {
  countries = [];
}
...
function setHour() {
  var now = new Date();
  var formatted = 'Logged at: ' + now.getHours() + ':' + now.getMinutes();
  document.getElementById('timestamp').innerHTML = formatted;
}
...
setHour();
autocomplete(document.getElementById('task'), countries);
